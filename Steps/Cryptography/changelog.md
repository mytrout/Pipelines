...
## 3.2.0
 ...
 - Upgrade CreateNewZipArchiveStep to use AbstractCachingPipelineStep to eliminate an unnecessary context item removal which caused code coverage decrease.
